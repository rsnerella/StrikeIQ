...
export default function AuthPage() {
  ...
  useEffect(() => {
    ...
    const defaultAuthData: AuthRequiredData = {
      ...
      mode: "AUTH",
      login_url: `https://api.upstox.com/v2/login/authorization/dialog?response_type=code&client_id=${process.env.NEXT_PUBLIC_UPSTOX_CLIENT_ID || '53c878a9-3f5d-44f9-aa2d-2528d34a24cd'}&redirect_uri=${process.env.NEXT_PUBLIC_API_URL || 'https://strikeiq-production-e1cd.up.railway.app'}/api/v1/auth/upstox/callback`,
